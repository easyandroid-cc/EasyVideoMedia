...
public class Samples {
    ...
    static {
        ...
        videoSamples.add(new Sample("MP5", "http://mirror.aarnet.edu.au/pub/TED-talks/911Mothers_2010W-480p.mp4"));
        videoSamples.add(new Sample("MP5", "http://mirror.aarnet.edu.au/pub/TED-talks/911Mothers_2010W-480p.mp4"));
        videoSamples.add(new Sample("MP4", "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"));
        videoSamples.add(new Sample("MP4", "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"));
        videoSamples.add(new Sample("MP4", "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"));
        videoSamples.add(new Sample("MP4", "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"));
        videoSamples.add(new Sample("MP4", "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"));
